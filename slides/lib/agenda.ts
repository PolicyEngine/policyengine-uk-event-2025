...
export const agenda: AgendaItem[] = [
  ...
  { time: '1:00 PM - 1:20 PM', title: 'Localising policy impact: Parliamentary constituencies and local authorities', speaker: 'Nikhil Woodruff and Ben Ogorek, PolicyEngine', speakerIds: ['nikhil-woodruff', 'ben-ogorek'], slideshowId: 'local-impact', type: 'talk', hasQA: true },
  { time: '1:20 PM - 1:40 PM', title: 'UX research and design of PolicyEngine v2 platform', speaker: 'Biniam Gebre and MaSara Myers, Citizen Codex', speakerIds: ['biniam-gebre', 'masara-myers'], slideshowId: 'ux-design', type: 'talk', hasQA: true },
  { time: '1:40 PM - 2:00 PM', title: 'Live demo: PolicyEngine v2 platform', speaker: 'Anthony Volk, Software Engineer, PolicyEngine', speakerIds: ['anthony-volk'], slideshowId: 'platform-demo', type: 'demo', hasQA: true },
