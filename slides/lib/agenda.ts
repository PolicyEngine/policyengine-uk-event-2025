...
export const agenda: AgendaItem[] = [
  ...
  { time: '12:40 PM - 12:50 PM', title: 'Technology and AI for UK policymaking: The PolicyEngine approach', speaker: 'Nikhil Woodruff, Co-founder & CTO, PolicyEngine', speakerIds: ['nikhil-woodruff'], slideshowId: 'tech-ai-2025', type: 'talk' },
  { time: '12:50 PM - 1:00 PM', title: 'Scope of the model: Rules, data, and dynamics', speaker: 'Vahid Ahmadi, Research Associate, PolicyEngine', speakerIds: ['vahid-ahmadi'], slideshowId: 'model-scope', type: 'talk' },
  { time: '1:00 PM - 1:20 PM', title: 'Live demo: PolicyEngine v2 platform', speaker: 'Anthony Volk, Software Engineer, PolicyEngine', speakerIds: ['anthony-volk'], slideshowId: 'platform-demo', type: 'demo' },
  { time: '1:20 PM - 1:40 PM', title: 'UX research and design of PolicyEngine v2 platform', speaker: 'Biniam Gebre and MaSara Myers, Citizen Codex', speakerIds: ['biniam-gebre', 'masara-myers'], slideshowId: 'ux-design', type: 'talk' },
  ...
  { time: '3:20 PM - 3:40 PM', title: 'PolicyEngine US: Modelling federal, state, and local policies', speaker: 'Pavel Makarchuk, Daphne Hansell, and David Trimmer, PolicyEngine', speakerIds: ['pavel-makarchuk', 'daphne-hansell', 'david-trimmer'], slideshowId: 'policyengine-us', type: 'talk' },
  ...
  { time: '4:25 PM - 5:00 PM', title: 'Looking ahead: AI-powered policy analysis', speaker: 'Max Ghenis, Nikhil Woodruff, Vahid Ahmadi', speakerIds: ['max-ghenis', 'nikhil-woodruff', 'vahid-ahmadi'], slideshowId: 'ai-future', type: 'talk' },
