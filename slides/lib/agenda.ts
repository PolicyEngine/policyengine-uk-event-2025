...
export const agenda: AgendaItem[] = [
  ...
  { time: '3:20 PM - 3:40 PM', title: 'PolicyEngine US: The One Big Beautiful Bill Act household-by-household', speaker: 'Daphne Hansell and David Trimmer, PolicyEngine', speakerIds: ['daphne-hansell', 'david-trimmer'], slideshowId: 'policyengine-us', type: 'talk', hasQA: true },
