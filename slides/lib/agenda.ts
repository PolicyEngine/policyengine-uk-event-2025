...
export const agenda: AgendaItem[] = [
  ...
  { time: '1:40 PM - 2:00 PM', title: 'Localising policy impact: Parliamentary constituencies and local authorities', speaker: 'Nikhil Woodruff and Ben Ogorek, PolicyEngine', slideshowId: 'local-impact', type: 'talk' },
  ...
  { time: '3:20 PM - 3:40 PM', title: 'PolicyEngine US: Modelling federal, state, and local policies', speaker: 'Pavel Makarchuk, Daphne Hansell, and David Trimmer, PolicyEngine', slideshowId: 'policyengine-us', type: 'talk' },
