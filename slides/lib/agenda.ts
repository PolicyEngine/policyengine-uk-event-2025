...
export const agenda: AgendaItem[] = [
  ...
  { time: '12:50 PM - 1:00 PM', title: 'Scope of the model: Policies, households, and dynamics', speakerIds: ['vahid-ahmadi'], slideshowId: 'model-scope', type: 'talk' },
  { time: '1:00 PM - 1:20 PM', title: 'Localising policy impact: Parliamentary constituencies and local authorities', speakerIds: ['nikhil-woodruff', 'ben-ogorek'], slideshowId: 'local-impact', type: 'talk', hasQA: true },
  { time: '1:20 PM - 1:40 PM', title: 'UX research and design of PolicyEngine v2 platform', speakerIds: ['biniam-gebre', 'masara-myers'], slideshowId: 'ux-design', type: 'talk', hasQA: true },
  ...
  { time: '2:20 PM - 2:40 PM', title: "NIESR's use of PolicyEngine in its living standards review", speakerIds: ['max-mosley'], slideshowId: 'niesr-review', type: 'talk' },
  { time: '2:40 PM - 3:00 PM', title: 'Microsimulation of a carbon dividend', speakerIds: ['malcolm-torry'], slideshowId: 'carbon-dividend', type: 'talk' },
  { time: '3:00 PM - 3:20 PM', title: 'VAT analysis with synthetic firm microdata', speakerIds: ['vahid-ahmadi'], slideshowId: 'vat-analysis', type: 'talk' },
  ...
  { time: '4:25 PM - 5:00 PM', title: 'Looking ahead: AI-powered policy analysis', speakerIds: ['max-ghenis', 'nikhil-woodruff', 'vahid-ahmadi'], slideshowId: 'ai-future', type: 'talk', hasQA: true },
