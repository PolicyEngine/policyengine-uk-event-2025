      ...
      <div className="">
        ...
        <div className="flex justify-center items-center gap-12 mt-20">
          <div style={{ backgroundColor: colors.primary[500], width: '320px', height: '320px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: 'bold', color: colors.white }}>Policies</h2>
          </div>
          ...
          <div style={{ backgroundColor: colors.primary[700], width: '320px', height: '320px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: 'bold', color: colors.white }}>Dynamics</h2>
          </div>
          ...
          <div style={{ backgroundColor: colors.primary[800], width: '320px', height: '320px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '8px' }}>
            <h2 style={{ fontSize: '3rem', fontWeight: 'bold', color: colors.white }}>Households</h2>
          </div>
        </div>
      </div>
    </Slide>
