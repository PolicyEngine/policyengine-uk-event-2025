        ...
        <SlideContent size="md">
          <div className="space-y-6 text-left">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xl font-medium text-pe-teal">
                Our first major UK grant — a transformative moment for PolicyEngine.
              </p>
            </div>

            <div className="mt-8 p-6 bg-pe-teal/10 rounded-lg border-l-4 border-pe-teal">
              <p className="text-xl font-medium text-pe-dark">
